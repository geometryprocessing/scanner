...
class ThreeDUtils:
    ...
    def triangulate_pixels(
        ...
        want to triangulat, take the average between the tuple returned
        """
    ...
    @staticmethod
    def point_cloud_from_depth_map(depth_map: np.ndarray,
                                   R: np.ndarray,
                                   T: np.ndarray,
    ...
    @staticmethod
    def depth_map_from_point_cloud(points: np.ndarray,
                                   ) -> np.ndarray:
        """
